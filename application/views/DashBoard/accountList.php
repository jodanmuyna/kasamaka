      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
              <button class="btn btn-success" onclick="add_accounts()"><i class="glyphicon glyphicon-plus"></i> Add Account</button>
              <br><br>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h3 class="modal-title">KsamaKa Form</h3>
                  </div>
...
<script type="text/javascript">
  ...
  function edit_accounts(id)
  {
    ...
    $.ajax({
      url : "<?php echo site_url('accounts/ajax_edit/')?>/" + id,
      type: "GET",
      dataType: "JSON",
