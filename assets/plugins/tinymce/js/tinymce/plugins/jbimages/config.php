...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = 'http://'.$_SERVER['HTTP_HOST'].'/kasamaka/upload/uploads'; // Relative to domain name
	$config['img_location'] = '/kasamaka/upload/uploads';
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_location']; // Physical path. [Usually works fine like this]
